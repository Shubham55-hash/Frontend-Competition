...
export function ArrowPath({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} style={style} aria-hidden={ariaHidden}>
...
export function ArrowTrendingUp({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function ChartPie({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function ChevronDown({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function ChevronUp({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function ChevronLeft({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function ChevronRight({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function ChevronUpSolid({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function Cog8Tooth({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
      <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function Cube({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className={className} style={style} aria-hidden={ariaHidden}>
...
export function Link({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function LinkSolid({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function Search({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className={className} style={style} aria-hidden={ariaHidden}>
...
export function XMark({ className, style, 'aria-hidden': ariaHidden }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} style={style} aria-hidden={ariaHidden}>
...
export function getIconByName(name: string, props?: IconProps) {
  const icons: Record<string, React.ReactElement> = {
    ArrowPath: <ArrowPath {...props} />,
    ArrowTrendingUp: <ArrowTrendingUp {...props} />,
    ChartPie: <ChartPie {...props} />,
    ChevronDown: <ChevronDown {...props} />,
    ChevronUp: <ChevronUp {...props} />,
    ChevronLeft: <ChevronLeft {...props} />,
    ChevronRight: <ChevronRight {...props} />,
    ChevronUpSolid: <ChevronUpSolid {...props} />,
    Cog8Tooth: <Cog8Tooth {...props} />,
    Cube: <Cube {...props} />,
    Link: <Link {...props} />,
    LinkSolid: <LinkSolid {...props} />,
    Search: <Search {...props} />,
    XMark: <XMark {...props} />,
  }
